...
- (void)viewDidLoad {
    ...
    ZHNunlimitedCarouselView * temp = [ZHNunlimitedCarouselView zhn_instanceCarouselViewUseImageArray:@[] frame:CGRectMake(0, 0, 200, 200) placeHolder:[UIImage imageNamed:@"tutu"] imageContentMode:ZHN_contentModeDefault pageControlMode:pageControlModeLeft timerTime:5 didSelectItemBlock:^(NSInteger index) {
        NSLog(@"%ld",(long)index);
    }];
